...
exports.init = async (req, res) => {
    ...
    Game.create([
      ...
      { name: 'F1 2022', type:"Racing", price: 59.99, description: "Take the wheel of a Formula One car and race to victory in F1 2021. This racing game features realistic physics, challenging AI opponents, and a variety of tracks to race on.", img: 'http://drive.google.com/uc?export=view&id=1DOET63YbwTBgvObQb10iXDXKrLMgvTN9', avgClassification: avgClassification, allClassifications: allClassifications},
